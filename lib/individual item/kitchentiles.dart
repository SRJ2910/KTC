...
class Kitchentiles extends StatefulWidget {
  const Kitchentiles({Key? key}) : super(key: key);

  @override
  _KitchentilesState createState() => _KitchentilesState();
}

class _KitchentilesState extends State<Kitchentiles> {
  List<int> data = [];
  int _focusedIndex = 0;
